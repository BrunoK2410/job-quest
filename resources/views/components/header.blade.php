<header class="bg-gray-900 text-amber-100 p-4" x-data="{ open: false }">
    <div class="container mx-auto flex justify-between items-center">
        <h1 class="text-3xl font-semibold text-amber-300">
            <a href="{{url('/')}}">Job Quest</a>
        </h1>
        ...
        <button 
            @click="open = !open"
            id="hamburger"
            class="text-amber-300 md:hidden flex items-center">  
    ...
    <nav x-show="open"
        ...
        id="mobile-menu"
        class="md:hidden bg-gray-900 text-amber-100 mt-5 pb-4 space-y-2">
        ...
        <x-logout-button />
        <div class="pt-2"></div>
        <x-button-link url="/jobs/create" icon="edit" :block="true" class="bg-amber-500 hover:bg-amber-600 text-gray-900">Create Job</x-button-link>
        @else
